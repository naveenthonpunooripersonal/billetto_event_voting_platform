...
ActiveRecord::Schema[8.1].define(version: 2026_08_24_200047) do
  ...
  create_table "event_store_events_in_streams", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.uuid "event_id", null: false
    t.integer "position"
    t.string "stream", null: false
    t.index ["event_id"], name: "index_event_store_events_in_streams_on_event_id", unique: true
    t.index ["stream", "position"], name: "index_event_store_events_on_stream_and_position", unique: true
  end
